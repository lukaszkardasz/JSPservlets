...
<div class="grid">
        ...
        <c:when test="${ empty sessionScope.user }">
            ...
            <form action=${ pageContext.request.contextPath }/login method="POST" class="form login">
                ...
                <div class="form__field">
                    ...
                    <input id="login__username" type="text" name="login" class="form__input" placeholder="Login"
                           required>
                </div>
                ...
                <div class="form__field">
                    ...
                    <input id="login__password" type="password" name="password" class="form__input" placeholder="Hasło"
                           required>
                </div>
    ...
    <p class="text--center"><a href="${ pageContext.request.contextPath }/registration">Zarejestruj się</a>
        <svg class="icon">
